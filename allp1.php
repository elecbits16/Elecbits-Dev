...
?>
              ...
              if (($pro_id == '5') || ($pro_id == '3'))
          {
...

            {
              ...
              ?>
              <a  href="#"><img src="admin_area/product_img/<?php echo $pro_image; ?>" width='200' height='180' ></a>

             
  <h3 class="cbp-vm-title"><a href="details1.php?pro_id=<?php echo $pro_id; ?>"><?php echo $pro_title;  ?></a></h3>



              <div class="cbp-vm-price" style="color:black;"> ₹ <?php echo $pro_price;  ?></div>
              <div class="cbp-vm-details">
              <?php echo "$pro_cat1,  $pro_cat2, $pro_cat3"; ?>&nbspand <?php echo" $pro_cat4;"?>
              </div>
