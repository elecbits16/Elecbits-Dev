...
<hr>
   ...
   <div class="container">
   <div class="jumbotron">
     <div  style="font-size: 40px; padding: 0px 0px 0px 0px;" > <span style="font-family: 'Faster One', cursive; font-size:68px; color: red;">C</span>ONTACT US</div> 
      ...
      <div class="col-lg-7" style="text-align:center;margin-top: 27px;">
        <iframe class="hidden-lg" width="360" height="255" src="https://www.youtube.com/embed/v3Q-hDO-Ljs" frameborder="0" allowfullscreen></iframe>
