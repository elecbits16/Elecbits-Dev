...
<div class="table-responsive " style=" font-family: 'Montserrat', sans-serif;  padding: 0px 0px 10px 0px";>
  ...
  <tr>
      <td>Pic 1:</td>
    <td> <input type="url" name="link1" size="60"  value="<?php echo $link1 ;?>"  required/>
  ...
  <tr>
    ...
    <tr>
      <td>Output 2:</td>
    <td> <input type="url" name="link3" size="60"  value="<?php echo $link3 ;?>" required/></td> 
  </tr>
<tr>
      <td>Output 3:</td>
    <td> <input type="url" name="link4"  size="60"  value="<?php echo $link4 ;?>" required/></td> 
  </tr>
...
<tr>
      <td></td>
    <td> <input type="submit" name="update_post" value="Inerst the software" ></td> 
  </tr>
...
if ( (isset($_POST['update_post'])) ) {
  //getting the text data
   ...
   $insert_software = "UPDATE software SET  soft_id  ='$software_id ', soft_title = '$software_title' , soft_person_name = '$soft_person', soft_desc = '$soft_desc', soft_coding ='$soft_code', soft_profile='$soft_profile', pic1 = '$link1', output1 ='$link2', output2 ='$link3', output3='$link4' WHERE soft_id= '$software_id' " ;
