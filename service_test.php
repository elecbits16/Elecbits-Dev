...
<!-- Readymade project form -->
  ...
  <form class="cbp-mc-form" method="post" action="">
    <div  ng-if="weapon=='Readymade Project'">Readymade project form!
  ...
  <label for="phone">Phone Number</label>
    ...
    <label for="phone">Your Location </label>
       <md-select name="loc1" ng-model="loc1" class="md-no-underline" required>
                      <md-option value="e">New Delhi</md-option>
                      <md-option value="en">Noida</md-option>
                      <md-option value="us">Gurgaon</md-option>
                                            <md-option value="us">Ghaziabad</md-option>
                                            <md-option value="us">Outside NCR</md-option>
                    </md-select>
