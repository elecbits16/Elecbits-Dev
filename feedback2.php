          ...
          <div class="container">
              ...
              <div class="col-lg-6">
                <md-input-container class="md-block">
                  ...
                  <input class="feedbackInput" ng-model="user.name" type="text" type="text" name="na1" placeholder="Name"  ng-required="true">
                </md-input-container>

                <md-input-container class="md-block">
                  <!-- Use floating placeholder instead of label -->
                  <md-icon md-svg-src="img/icons/ic_email_24px.svg" class="number"></md-icon>
                  <input class="feedbackInput" type="number"  ng-model="user.number" name="ph1" placeholder="Phone number" ng-required="true">
                </md-input-container>

                <md-input-container class="md-block">
                  <!-- Use floating placeholder instead of label -->
                  <md-icon md-svg-src="img/icons/ic_email_24px.svg" class="email"></md-icon>
                  <input class="feedbackInput"  ng-model="user.email" type="email"  name="em1" placeholder="Email (required)" ng-required="true">
                </md-input-container>

                <md-input-container md-icon-float class="md-block">
                  <md-icon md-svg-src="img/icons/ic_phone_24px.svg"   ></md-icon>
                  <input class="feedbackInput"  ng-model="user.phone" type="text" name="pt1" placeholder="Project Title" required="true"></md-input-container>
                ...
                <div class="col-lg-6">
                  <md-input-container class="md-block">
                    <!-- Use floating placeholder instead of label -->
                    <md-icon md-svg-src="img/icons/ic_email_24px.svg" class="email"></md-icon>
                    <input class="feedbackInput"  ng-model="user.college" type="text" name="col1" placeholder="College" ng-required="true">
                  </md-input-container>
                   <md-input-container class="md-block">
                    <!-- Use floating placeholder instead of label -->
                    <md-icon md-svg-src="img/icons/ic_email_24px.svg" class="email"></md-icon>
                    <input class="feedbackInput"  ng-model="user.ser" type="text" name="ser1" placeholder="What services we should add ?" ng-required="true">
                  </md-input-container>
                  <div >
              ...
              <div class="col-lg-12" style="width: 100%;">
                ...
                <md-input-container style="width: 100%;" md-icon-float class="md-block">
                  <md-icon md-svg-src="img/icons/ic_phone_24px.svg"></md-icon>
                  <input class="feedbackInput"  ng-model="user.exp" type="text" name="exp" placeholder="How was your experience with us ?"></md-input-container>
