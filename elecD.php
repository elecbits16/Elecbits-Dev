...
<html lang="en" data-ng-app="themeonApp">
	<head>
		...
		<link rel="stylesheet" type="text/css" href="styles/assets/css/bootstrap.css" media="screen">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/font-awesome.min.css" media="screen">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/simple-line-icons.css" media="screen">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/material-design-iconic-font.css" media="screen">
		<link href="styles/assets/css/owl.carousel.css" type="text/css" rel="stylesheet" media="screen">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/global.css" media="screen">
		<!-- RS5.0 Main Stylesheet -->
		<link rel="stylesheet" type="text/css" href="styles/assets/css/settings.css">
		<!-- RS5.0 Layers and Navigation Styles -->
		<link rel="stylesheet" type="text/css" href="styles/assets/css/layers.css">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/navigation.css">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/style.css" media="screen">
		<link rel="stylesheet" type="text/css" href="styles/assets/css/responsive.css" media="screen">
		<link rel="stylesheet" type="text/less" href="styles/assets/css/skin.less" media="screen">
...
<div class="there">
									<span style="font-size: 20px;">WELCOME TO ELECDUINO</span>
								</div>
								<div class="who-slider">
									<div class="item">
										<div class="header-wrap">
											<h2 class="text-left">What <span> is Elecduino ? </span></h2>
											<p style=" font-size: 16px; text-align: justify; font-family: 'montserratregular'; font-weight: 300px;">
											...
											<p style=" font-size: 16px; text-align: justify; font-family: 'montserratregular'; font-weight: 300px;">This kit will increase your efficiency of self-learning and can save a lot of time and money by the cutting the cost and time on specialised training. Our team has designed several services with the kit that will ease down every process.</p>
						...
						<div class="row padding">
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>C</strong><small>Components</small></h3>
								</div>
							...
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>s</strong><small>Software/Coding</small></h3>
								</div>
								<p style="text-align: justify; ">
							...
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>V</strong><small>Videos</small></h3>
								</div>
								<p style="text-align: justify; ">
						...
						<div class="row">
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>A</strong><small>Arduino &amp; Development</small></h3>
								</div>
								<p style="text-align: justify; ">
							...
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>I</strong><small>Instructions Manual</small></h3>
								</div>
								<p style="text-align: justify; ">
							...
							<div class="col-xs-12 col-sm-4 zoom">
								<div class="inner-header-wraper">
									...
									<h3><strong>b</strong><small>Assistance</small></h3>
								</div>
								<p>
				...
				<section class="skills">
					...
					<div class="row" >
						<div class="left-sec">
							<img src="images/pack1.png" alt="" data-video="https://www.youtube.com/watch?v=s7sdWRgtzX0">
	...
	<section id="mainFooter">
			...
			<div class="row">
				<div class="col-sm-6">
					<div class="footerWidget" style="font-family: 'Muli', sans-serif;">
						<h3>Elecbits</h3>
						<p style="color: white; font-family: 'Muli', sans-serif;">We are a group of Enthusiasts who focus on making things simpler. Technology is an artistic way to turn your imagination into reality. And we are here to make sure that the artistic approach inside you would never go out of resource.</p>
					</div>
				</div>
				<div class="col-sm-3">
					<div class="footerWidget">
						...
						<address>
							<p style="font-family: 'Muli', sans-serif; color: white;"> New Delhi<br>
								Gurgaon<br>
								Noida
								&nbsp;+91-9911806843 <br>
								<i class="icon-mail-alt"></i><a href="mailto:elecbits16@gmail.com" style="color: white;">elecbits16@gmail.com</a> </p>
							</address>
						</div>
					</div>
					<div class="col-sm-3">
						<div class="footerWidget">
							<h4 style="font-family: 'Muli', sans-serif;" style="color: white;">Follow us, we are social</h4>
		...
		<section id="footerRights">
			<div class="container">
				<div class="row">
					<div class="col-md-12">
						<p style="font-family: 'Muli', sans-serif;color: white;">Copyright © 2016 <a href="http://elecbits.in" target="blank" style="color: white;">Elecbits</a> / All rights reserved.<div style="float:right;color: white;">Made with<span style="font-size:200%;color:red">&hearts;</span> in India!</div> </p>  
		...
		<!--Page Wrapper End-->
		<script type="text/javascript" src="styles/assets/js/jquery-1.11.3.min.js"></script>
		<script type="text/javascript" src="styles/assets/js/bootstrap.js"></script>
		<script type="text/javascript" src="styles/assets/js/less.js"></script>
		<script type="text/javascript" src="styles/assets/js/angular.js"></script>
		<script type="text/javascript" src="styles/assets/js/app.js"></script>
		<script type="text/javascript" src="styles/assets/js/jquery.appear.js"></script>
		<script type="text/javascript" src="styles/assets/js/isotope.pkgd.min.js"></script>

		<!-- revolution Js -->
		<!-- RS5.0 Core JS Files -->
		<script type="text/javascript" src="styles/assets/js/jquery.themepunch.tools.min.js"></script>
		<script type="text/javascript" src="styles/assets/js/jquery.themepunch.revolution.min.js"></script>
		<script type="text/javascript" src="styles/assets/extensions/revolution.extension.slideanims.min.js"></script>
		<script type="text/javascript" src="styles/assets/extensions/revolution.extension.actions.min.js"></script>
		<script type="text/javascript" src="styles/assets/extensions/revolution.extension.layeranimation.min.js"></script>
		<script type="text/javascript" src="styles/assets/extensions/revolution.extension.navigation.min.js"></script>
		<script type="text/javascript" src="styles/assets/js/jquery.revolution.js"></script>
		<!-- revolution Js-->
		<script type="text/javascript" src="styles/assets/js/owl.carousel.js"></script>
		<script type="text/javascript" src="styles/assets/js/count.js"></script>
		<script type="text/javascript" src="styles/assets/js/site.js"></script>
		<script type="text/javascript" src="styles/assets/js/nav.js"></script>
