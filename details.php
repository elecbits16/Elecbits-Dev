...
<div  class="col-lg-12 col-xs-12 col-md-12 col-sm-12 ">
    ...
    while ($row_pro = mysqli_fetch_array($run_pro)) 
    {
      ...
      <a href='details.php?rp_cart=$pro_id' style='float:right';> <img src='images/addtocart.png' width='30' height='30' /> </a>

      <a href='details.php?diy_cart=$pro_id' style='float:right';> <img src='images/addtocart.png' width='30' height='30' /> </a>

      <a href='details.php?buy_now=$pro_id' style='float:right';> <img src='images/addtocart.png' width='30' height='30' /> </a>
