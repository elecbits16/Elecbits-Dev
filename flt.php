...
<div class="panel-group"  >
  <div class="panel panel-default" >
    <div class="panel-heading" >
      <h4 class="panel-title"  >
        <a data-toggle="collapse" href="#collapse1" style="color: black; font-size: 16px;"  ><strong>REEQUEST A CALLBACK</strong></a>
      </h4>
    </div>
 ...
 <div class="form-group">
    ...
    <input type="email" class="form-control" name="name" id="email" required>
  </div>
  <div class="form-group">
