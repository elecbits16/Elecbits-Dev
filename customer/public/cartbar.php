...
<html lang="en" class="no-js">
    ...
    <?php
     ...
     else
     {
       ...
       echo "<a href='logout.php' style='padding:0px 0px 0px 10px; '>logout</a> ";
    ...
    <div class="panel panel-default">
      <div class="panel-heading" style="background-color: #0070FF; border-style: solid; border-color:  #0070FF; ">
        <h4 class="panel-title">
          <a data-toggle="collapse" data-parent="#accordion" href="#collapse65" style="color: white; ">Highlights </a>
        </h4>
      </div>
