  ...
  <div class="container">
    ...
    <?php
     if (!isset($_SESSION['customer_email'])) {
       ...
       echo "
       <br><p style='padding: 10px 0px 0px 10px;'><span class='glyphicon glyphicon-user' style='vertical-align: text-top; padding-right:10px; '> </span>Hi Guest</p>" ; 
    ...
    <a href="../cart1.php" style="padding:50px 0px 0px 10px; ">&nbspCart :<?php total_items(); ?></a> 
    <?php
     if (!isset($_SESSION['customer_email'])) {

      echo "<a href='../checkout1.php' style='padding:50px 0px 0px 10px; '>Login</a> ";
     }
     else
     {
