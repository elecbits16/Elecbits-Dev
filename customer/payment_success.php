...
<form method="post" action=" ">
  <tr>
     ...
     <td><button type="submit" name='cashon'><a href="checkout.php?cashon_delivery" style="text-decoration: none; color: black; "> Cash on Delivery</a> </button> </td>

  </tr>

  <tr>
  <td><button type="submit" name='cashon'  >Paytm</button></td>
